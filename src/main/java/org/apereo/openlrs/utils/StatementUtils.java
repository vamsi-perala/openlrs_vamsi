...
public class StatementUtils {
	...
	public static final String RELATED_ACTIVITIES_FILTER = "related_activities";
     ...
     */
    public static Map<String, String> createStatementFilterMap(String actor, String activity, String since, String until, String limit, String related_activities) {
       ...
       // actor
        ...
        if (!StringUtils.isEmpty(related_activities)) {
            filterMap.put(RELATED_ACTIVITIES_FILTER,related_activities );
        }
     // activity
